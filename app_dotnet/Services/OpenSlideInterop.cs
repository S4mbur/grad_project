...
/// <summary>
/// P/Invoke bindings for libopenslide (OpenSlide C library).
/// 
/// OpenSlide is a C library for reading whole-slide images (WSIs).
/// This class provides safe .NET wrappers around the native functions.
/// 
/// PREREQUISITES:
///   Ubuntu/Debian: sudo apt-get install libopenslide0 libopenslide-dev
///   macOS:         brew install openslide
///   Windows:       Download from https://openslide.org/download/
/// </summary>
public static class OpenSlideInterop
{
    private const string LibName = "libopenslide";
